...
function checkFile(file) {
  ...
  if (BLOCKING_ARTIFACT_STATUSES.has(data.status)) findings.push({ code: "ARTIFACT_STATUS_NOT_USABLE", file: rel(file), status: data.status, fallbackAction: data.fallbackAction })
