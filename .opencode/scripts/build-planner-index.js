...
const { artifactDir, commonArtifact, exitForStatus, output, parseArgs, printAndExitUsage, readText, rel, resolveOutPath, resolveRoot, sha256File, writeJson } = require("./lib/artifact-utils")
...
if (existsSync(planner)) {
  const lines = readText(planner).split(/\r?\n/)
