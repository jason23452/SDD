...
const { BLOCKING_ARTIFACT_STATUSES, artifactDir, commonArtifact, exitForStatus, output, parseArgs, printAndExitUsage, rel, resolveOutPath, writeJson } = require("./lib/artifact-utils")
...
const blockers = BLOCKING_ARTIFACT_STATUSES.has(checkStatus) ? [`VERIFICATION_${String(checkStatus).toUpperCase()}`] : []
