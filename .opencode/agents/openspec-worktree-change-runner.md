...
- gate blocker：無 / `PROJECT_RULES_MISSING` / `PROJECT_RULES_ALIGNMENT_FAILED` / `DEPENDENCY_SYNC_FAILED` / `STAGE_BASELINE_MISSING_UPSTREAM` / `CLASSIFICATION_STAGE_INVALID` / `OPENSPEC_ARTIFACTS_MISSING`
