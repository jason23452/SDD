...
function formatAnalysis(analysis, projectSignals, requirementText) {
  ...
  return [
    ...
    "- 若需要新增/更新後續專案規則或存在 .opencode/skills/frontend/*/SKILL.md、.opencode/skills/backend/*/SKILL.md，產檔前需交給 project-start-rules-definer agent 整理或寫入專案啟動前規則；推薦或待確認規則不可寫成已確認。",
